...
const FuturePlansC1Exercise = () => {
  const exercises = [
    {
      id: 1,
      words: ['We', 'are', 'travelling', 'on', 'the', 'same', 'plane', 'to', 'Tokyo.'],
      correctOrder: ['We', 'are', 'travelling', 'on', 'the', 'same', 'plane', 'to', 'Tokyo.']
    },
    {
      id: 2,
      words: ['I', 'will', 'be', 'speaking', 'to', 'a', 'colleague', 'about', 'it.'],
      correctOrder: ['I', 'will', 'be', 'speaking', 'to', 'a', 'colleague', 'about', 'it.']
    },
    {
      id: 3,
      words: ['We', 'are', 'going', 'to', 'set', 'off', 'a', 'little', 'earlier', 'than', 'planned.'],
      correctOrder: ['We', 'are', 'going', 'to', 'set', 'off', 'a', 'little', 'earlier', 'than', 'planned.']
    },
    {
      id: 4,
      words: ['She', 'will', 'be', 'waiting', 'for', 'us', 'near', 'the', 'entrance.'],
      correctOrder: ['She', 'will', 'be', 'waiting', 'for', 'us', 'near', 'the', 'entrance.']
    },
    {
      id: 5,
      words: ['The', 'train', 'leaves', 'at', 'six', 'and', 'gets', 'there', 'an', 'hour', 'later.'],
      correctOrder: ['The', 'train', 'leaves', 'at', 'six', 'and', 'gets', 'there', 'an', 'hour', 'later.']
    },
    {
      id: 6,
      words: ['Someone', 'else', 'will', 'be', 'looking', 'after', 'the', 'arrangements.'],
      correctOrder: ['Someone', 'else', 'will', 'be', 'looking', 'after', 'the', 'arrangements.']
    },
    {
      id: 7,
      words: ['Hurry', 'up', 'because', 'the', 'match', 'is', 'about', 'to', 'start.'],
      correctOrder: ['Hurry', 'up', 'because', 'the', 'match', 'is', 'about', 'to', 'start.']
    },
    {
      id: 8,
      words: ['There', 'is', 'due', 'to', 'be', 'an', 'official', 'public', 'announcement.'],
      correctOrder: ['There', 'is', 'due', 'to', 'be', 'an', 'official', 'public', 'announcement.']
    },
    {
      id: 9,
      words: ['I', 'was', 'on', 'the', 'point', 'of', 'losing', 'my', 'temper', 'with', 'her.'],
      correctOrder: ['I', 'was', 'on', 'the', 'point', 'of', 'losing', 'my', 'temper', 'with', 'her.']
    },
    {
      id: 10,
      words: ['The', 'President', 'is', 'to', 'open', 'the', 'memorial', 'service.'],
      correctOrder: ['The', 'President', 'is', 'to', 'open', 'the', 'memorial', 'service.']
    }
  ];
      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-htb-card border border-gray-800 rounded-lg p-4 sm:p-8 shadow-lg">
          <h1 className="text-2xl sm:text-3xl font-bold text-htb-green mb-2">
            C1 Grammar: Expressing Future Plans and Arrangements
          </h1>
...
export default FuturePlansC1Exercise;
