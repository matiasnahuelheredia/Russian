...
const vocab = [
  { ru: 'лечение', tl: 'lecheniye', es: 'tratamiento' },
  { ru: 'диагноз', tl: 'diagnoz', es: 'diagnóstico' },
  { ru: 'симптом', tl: 'simptom', es: 'síntoma' },
  { ru: 'рецепт', tl: 'retsept', es: 'receta médica' },
  { ru: 'операция', tl: 'operatsiya', es: 'operación / cirugía' },
  { ru: 'прививка', tl: 'privivka', es: 'vacuna' },
  { ru: 'хирург', tl: 'khirurg', es: 'cirujano' },
  {
    ru: 'скорая помощь',
    tl: 'skoraya pomoshchʼ',
    es: 'ambulancia / emergencias',
  },
  { ru: 'больница', tl: 'bolʼnitsa', es: 'hospital' },
  { ru: 'поликлиника', tl: 'poliklinika', es: 'centro médico / policlínica' },
  { ru: 'врач', tl: 'vrach', es: 'médico / doctor' },
  { ru: 'медсестра', tl: 'medsestra', es: 'enfermera' },
  { ru: 'аптека', tl: 'apteka', es: 'farmacia' },
  { ru: 'таблетка', tl: 'tabletka', es: 'pastilla / comprimido' },
  { ru: 'анализ крови', tl: 'analiz krovi', es: 'análisis de sangre' },
  { ru: 'рентген', tl: 'rentgen', es: 'radiografía / rayos X' },
  { ru: 'аллергия', tl: 'allergiya', es: 'alergia' },
  {
    ru: 'хроническое заболевание',
    tl: 'khronicheskoye zabolevaniye',
    es: 'enfermedad crónica',
  },
  { ru: 'реабилитация', tl: 'reabilitatsiya', es: 'rehabilitación' },
  { ru: 'профилактика', tl: 'profilaktika', es: 'prevención' },
];
...
const quiz = [
  {
    id: 'q1',
    p: '"Лечение" significa:',
    o: ['diagnóstico', 'tratamiento', 'síntoma', 'cirugía'],
    c: 'tratamiento',
  },
  {
    id: 'q2',
    p: '¿Cómo se dice "vacuna"?',
    o: ['укол', 'лекарство', 'прививка', 'таблетка'],
    c: 'прививка',
  },
  {
    id: 'q3',
    ...
    c: 'ambulancia / emergencias',
  },
  {
    id: 'q4',
    p: '"Хирург" corresponde a:',
    o: ['médico general', 'especialista', 'cirujano', 'anestesista'],
    c: 'cirujano',
  },
  {
    id: 'q5',
    p: '¿Cuál significa "receta médica"?',
    o: ['rецепт', 'диагноз', 'симптом', 'анализ'],
    c: 'rецепт',
  },
  {
    id: 'q6',
    p: '"Аптека" es:',
    o: ['hospital', 'farmacia', 'clínica', 'quirófano'],
    c: 'farmacia',
  },
  {
    id: 'q7',
    p: '"Реабилитация" significa:',
    o: ['diagnóstico', 'cirugía', 'rehabilitación', 'prevención'],
    c: 'rehabilitación',
  },
  {
    id: 'q8',
    p: '¿Cómo se dice "análisis de sangre"?',
    o: ['рентген', 'МРТ', 'анализ крови', 'биопсия'],
    c: 'анализ крови',
  },
  {
    id: 'q9',
    p: '"Профилактика" es:',
    o: ['tratamiento', 'cura', 'prevención', 'diagnóstico'],
    c: 'prevención',
  },
  {
    id: 'q10',
    p: '"Хроническое заболевание" significa:',
    o: [
...
export default function SaludMedicinaC1Exercise() {
    ...
    <div className="max-w-4xl mx-auto px-4">
      <div className="bg-htb-card rounded-lg border border-gray-800 p-6 mb-6">
        <h2 className="text-3xl font-bold text-white mb-2">
          🏥 Salud y Medicina (Здоровье и медицина)
        </h2>
        <p className="text-htb-text-dim">
          Vocabulario C1 para hablar de salud, medicina y el sistema sanitario
          en ruso.
        </p>
      </div>
