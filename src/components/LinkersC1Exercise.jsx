...
const LinkersC1Exercise = () => {
  ...
  const leftSide = [
    { id: 1, text: 'Sales decreased dramatically and' },
    { id: 2, text: "Sally can't get a better job" },
    { id: 3, text: 'She wants to leave' },
    { id: 4, text: 'Maria is very good at her job and was recently made Sales Director' },
    { id: 5, text: 'The manager authorised a 5% discount' },
    { id: 6, text: 'She took the day off' },
    { id: 7, text: 'Carla is quite hardworking' },
    { id: 8, text: 'She loved her work' },
    { id: 9, text: 'In spite of all the criticism from colleagues,' },
    { id: 10, text: 'They promoted Ben despite' }
  ];

  const rightSide = [
    { id: 1, text: 'therefore profits were affected.' },
    { id: 5, text: 'in case some customers complain about the price.' },
    { id: 9, text: 'she improved results for the company.' },
    { id: 8, text: 'even though the hours were long.' },
    { id: 7, text: 'but she does make mistakes.' },
    { id: 6, text: "so that she wouldn't need to work." },
    { id: 4, text: 'in order to improve customer service.' },
    { id: 10, text: 'the fact that nobody liked him.' },
    { id: 3, text: 'because of the low pay.' },
    { id: 2, text: "because she doesn't have enough experience." }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-htb-card border border-gray-800 rounded-lg p-4 sm:p-8 shadow-lg">
          <h1 className="text-2xl sm:text-3xl font-bold text-htb-green mb-4">
            C1 Grammar: Discourse Markers (1) - Linkers
          </h1>
                      ...
                      <button
                        onClick={() => {
                          ...
                          if (selectedLeft) {
                            ...
                            // If all are matched, find the first one
...
export default LinkersC1Exercise;
