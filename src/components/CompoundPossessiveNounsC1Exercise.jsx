...
const CompoundPossessiveNounsC1Exercise = () => {
  ...
  const correctAnswers = {
    q1: "Mario's restaurant",
    q2: 'name of the place',
    q3: "ten minutes' walk",
    q4: "Tony's",
    q5: 'mine',
    q6: 'his dad',
    ...
    q8: 'piece of pizza',
    q9: 'glass of wine',
    q10: 'end of this film'
  };

  const options = {
    q1: ["Mario's restaurant", 'the restaurant of Mario'],
    q2: ["the place's name", 'name of the place'],
    q3: ["ten minutes' walk", 'a walk of ten minutes'],
    q4: ["Tony's", 'the house of Tony'],
    q5: ['my', 'mine'],
    q6: ['his dad', 'the dad of him'],
    q7: ['maths teacher', 'teacher of maths'],
    q8: ["pizza's piece", 'piece of pizza'],
    q9: ['glass of wine', 'wine glass'],
    q10: ['end of this film', "this film's end"]
  };
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-htb-card border border-gray-800 rounded-lg p-4 sm:p-8 shadow-lg">
          <h1 className="text-2xl sm:text-3xl font-bold text-htb-green mb-2">
            C1 Grammar: Nouns - Compound and Possessive Forms
          </h1>
          ...
          <div className="space-y-6 text-base sm:text-lg leading-relaxed">
            <div className="bg-htb-sidebar border border-gray-800 rounded-lg p-4">
              <p>
                <span className="font-bold text-htb-green">Peter:</span> Have you ever been to{' '}
                <select
                  value={answers.q1}
            ...
            <div className="bg-htb-sidebar border border-gray-800 rounded-lg p-4">
              <p>
                <span className="font-bold text-htb-green">Paul:</span> I didn't know he had one. What's the{' '}
                <select
                  value={answers.q2}
            ...
            <div className="bg-htb-sidebar border border-gray-800 rounded-lg p-4">
              <p>
                <span className="font-bold text-htb-green">Peter:</span> 'Super pizza' or something like that. It's not far,{' '}
                <select
                  value={answers.q3}
            ...
            <div className="bg-htb-sidebar border border-gray-800 rounded-lg p-4">
              <p>
                <span className="font-bold text-htb-green">Paul:</span> Tony? Who's Tony?
              </p>
            </div>

            <div className="bg-htb-sidebar border border-gray-800 rounded-lg p-4">
              <p>
                <span className="font-bold text-htb-green">Peter:</span> A friend of{' '}
                <select
                  value={answers.q5}
                ...
                {' '}from work. And believe it or not{' '}
                <select
                  value={answers.q6}
            ...
            <div className="bg-htb-sidebar border border-gray-800 rounded-lg p-4">
              <p>
                <span className="font-bold text-htb-green">Paul:</span> Interesting. Anyway, do you want to go to this restaurant? I'd love a nice{' '}
                <select
                  value={answers.q8}
            ...
            <div className="bg-htb-sidebar border border-gray-800 rounded-lg p-4">
              <p>
                <span className="font-bold text-htb-green">Peter:</span> Fine with me. I'll just watch the{' '}
                <select
                  value={answers.q10}
...
export default CompoundPossessiveNounsC1Exercise;
